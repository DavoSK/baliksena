#include "key_extractor.hpp"

namespace MFFormat
{

std::vector<DataFormatDTAKeyExtrator::DTAFile> DataFormatDTAKeyExtrator::fetchExecutableKeys(std::istream &srcFile, std::vector<DataFormatDTAKeyExtrator::DTAFile> & filesToFetch, uint32_t startOffset)
{
...
bool DataFormatDTAKeyExtrator::load(std::istream &srcFile)
{
    if (srcFile.good())
    {
        char AB_DTA[7] = {};
