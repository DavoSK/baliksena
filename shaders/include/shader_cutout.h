...
/*
    ...
    Overview:
        ...
        Shader program 'cutout':
            Get shader desc: cutout_shader_desc(sg_query_backend());
            Vertex shader: vs
                Attribute slots:
                    ATTR_vs_aPos = 0
                    ATTR_vs_aNormal = 1
    ...
    Shader descriptor structs:
        ...
        sg_shader cutout = sg_make_shader(cutout_shader_desc(sg_query_backend()));
...
*/
static const char vs_source_hlsl4[1199] = {
...
*/
static const char fs_source_hlsl4[793] = {
...
#endif
static inline const sg_shader_desc* cutout_shader_desc(sg_backend backend) {
