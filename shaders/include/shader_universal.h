...
/*
    ...
    vec3 computeLight(light_t light, vec3 normal, vec3 fragPos, vec3 viewDir, material_t mat)
    {
        switch (light.type)
        {
            ...
            case 1:
            {
                vec3 _409 = light.position - fragPos;
                float _412 = length(_409);
                float dist = _412;
                if (_412 <= light.range.x)
                {
                    dist = 1.0;
                }
                else
                ...
                return ((light.diffuse * max(dot(normalize(_409), normalize(normal)), 0.0)) * dist) * mat.diffuse;
            }
            case 3:
            {
                break;
            ...
            case 4:
            {
                float param = length(FragPos - vs_params[92].xyz);
                float param_1 = light.range.x;
                float param_2 = light.range.y;
                Fog = vec4(light.diffuse, getFogFactor(param, param_1, param_2));
                return vec3(0.0);
            }
            default:
            {
    ...
    void main()
    {
        ...
        {
            int _76 = int(aIndexes.x);
            mat4 _79 = mat4(vs_params[_76 * 4 + 12], vs_params[_76 * 4 + 13], vs_params[_76 * 4 + 14], vs_params[_76 * 4 + 15]);
            int _84 = int(aIndexes.y);
            mat4 _86 = mat4(vs_params[_84 * 4 + 12], vs_params[_84 * 4 + 13], vs_params[_84 * 4 + 14], vs_params[_84 * 4 + 15]);
            vec4 _93 = vec4(aPos, 1.0);
            newVertex = ((_79 * _93).xyz * aWeights.x) + ((_86 * _93).xyz * aWeights.y);
            vec4 _120 = vec4(aNormal, 0.0);
            newNormal = ((_79 * _120).xyz * aWeights.x) + ((_86 * _120).xyz * aWeights.y);
        }
        mat4 _144 = mat4(vs_params[0], vs_params[1], vs_params[2], vs_params[3]);
        FragPos = vec3((_144 * vec4(newVertex, 1.0)).xyz);
        ViewDir = normalize(FragPos - vs_params[92].xyz);
        Env = reflect(ViewDir, normalize(newNormal)) * vec3(1.0, -1.0, 1.0);
        mat4 _175 = transpose(inverse(_144));
        Norm = normalize(mat3(_175[0].xyz, _175[1].xyz, _175[2].xyz) * newNormal);
        TexCoord = aTexCoord;
        Fog = vec4(0.0);
        vec3 light = vec3(0.0);
        for (int i = 0; i < int(vs_params[93].y); i++)
        {
            ...
            vec3 _221 = computeLight(param_1, param_2, param_3, param_4, param_5);
            light += _221;
        }
        Light = light;
        ...
        {
            mat4 _505 = viewMat;
            _505[3] = vec4(0.0, 0.0, 0.0, 1.0);
            viewMat = _505;
        }
        mat4 modelView = viewMat * _144;
        if (int(vs_params[92].w) > 0)
        {
            mat4 _507 = modelView;
            _507[0].x = length(vec3(vs_params[0].xyz));
            mat4 _509 = _507;
            _509[0].y = 0.0;
            mat4 _511 = _509;
            _511[0].z = 0.0;
        ...
        vec4 _276 = vec4(newVertex, 1.0);
        ViewSpace = modelView * _276;
        gl_Position = (mat4(vs_params[8], vs_params[9], vs_params[10], vs_params[11]) * modelView) * _276;
    }
    
*/
static const char universal_vs_source_glsl330[5079] = {
    ...
    0x65,0x63,0x33,0x20,0x5f,0x34,0x39,0x32,0x3b,0x0a,0x0a,0x6d,0x61,0x74,0x65,0x72,
    ...
    0x2e,0x78,0x79,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0